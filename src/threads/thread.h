...
struct childprocess
  {
    tid_t tid;
    /* store its exit status to pass it to its parent */
    int exit_status;

    /* point to its parent's child_list */
    ...
    /* the semaphore of waiting thread */
...
struct thread
  {
    ...
    struct childprocess *childprocess;    /* This process's completion status. */
